<?php
//000000003600a:3:{i:0;i:404;i:1;s:1689:"<!DOCTYPE html>
<html>
<head>
    <title></title>
</head>
...
<div id="wrapper">
    <a href="http://demo.ocenter.cn"><img src="http://demo.ocenter.cn/404_icon.png" class="fade"></a>
    <div>
        <h1 class="fade">唉呀!</h1>
        <p class="fade">无法加载模块:Report<a style="color:#ff6600;margin-left: 20px;" href="http://demo.ocenter.cn">到这里去看看！</a></p>
        <a class="link" href="/" onclick="history.go(-1)" style="opacity: 1;">返回?</a>
    </div>
</div>
</body>
</html>";i:2;s:17:"/tmp/cookied42zZ7";}
?>