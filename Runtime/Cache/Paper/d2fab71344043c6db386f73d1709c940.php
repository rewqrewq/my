    ...
    <div class="clearfix ">
        ...
        <div class="col-xs-3">
            <div class="common_block_border">
                ...
                <div class="content ">
                    <ul class="menu-one">
                        <?php if(is_array($cat_list)): $i = 0; $__LIST__ = $cat_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i == 1){ $class='firstChild'; }else{ $class=''; } if($vo['type']=='article'){ if($vo['id'] == $id ){ $class.=' menu-show'; } }else{ if($vo['id'] == $top_id ){ $class.=' menu-show'; } } ?>
                            <li class="<?php echo ($class); ?>">
                                <?php if($vo['type'] == 'article'): ?><div class="header open">
                                        <a href="<?php echo U('Paper/Index/index',array('id'=>$vo['id']));?>" class="txt" style="width: 100%"><?php echo ($vo["title"]); ?></a>
                                    </div>
                                    <ul class="menu-two">
                                    </ul>
                                    <?php else: ?>
                                    <div class="header open">
                                        <a class="txt" style="width: 100%"><?php echo ($vo["title"]); ?> <span class="arrow"></span></a>
                                    </div>
                                    <ul class="menu-two" <?php if($vo['id'] == $top_id): ?>style="display:block"<?php endif; ?>>
                                        <?php if(is_array($vo['children'])): $i = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cd): $mod = ($i % 2 );++$i; if($i == 1){ $class='firstChild'; }else{ $class=''; } ?>
                                            <li class="<?php echo ($class); ?>">
                                                <a href="<?php echo U('Paper/Index/index',array('id'=>$cd['id']));?>"><?php echo ($cd["title"]); ?></a>
                                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </ul><?php endif; ?>
        ...
        <div class="col-xs-9">
            <div class="common_block_border">
                <div class="right_title">
                    ...
                    <span><?php echo ($content_title["title"]); ?></span>
                </div>
                <div style="padding: 10px;"><?php echo ($data["content"]); ?></div>
            </div>
        </div>
