            ...
            <div class="with-padding">
                <div class="text-center margin-top-15">
                    <ul style="width: 205px;display: inline-block" class="nav nav-primary">
                        <li id="type_1" style="width: 100px"><a href="<?php echo U('topic?type=1');?>"> <?php echo L('_HOT_24_');?></a>
                        </li>
                        <li id="type_2" style="width: 100px"><a href="<?php echo U('topic?type=2');?>"> <?php echo L('_HOT_7_');?></a></li>
                    </ul>
                    <script>
