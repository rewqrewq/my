...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <?php if($user_info['cover_id']): ?><img class="uc_top_img_bg" src="<?php echo ($user_info['cover_path']); ?>" style="width: 100%;height: 100%">
        <?php else: ?>
        <img class="uc_top_img_bg" src="/Application/Weibo/Static/images/user_top_default_bg.jpg" style="width: 100%;height: 100%"><?php endif; ?>
</div>
<div class="row uc_info">
    <div class="col-md-3 col-xs-4">
        <dl>
            <dt>
                <a href="<?php echo ($user_info["space_url"]); ?>">
            ...
            <dd>
                <div>
                    <div class="col-xs-6 text-center">
                        <a href="<?php echo U('Ucenter/Index/fans',array('uid'=>$user_info['uid']));?>" title="<?php echo L('_FANS_COUNT_');?>"><?php echo ($user_info["fans"]); ?></a><br><?php echo L('_FANS_');?>
                    </div>
                    <div class="col-xs-6 text-center">
                        <a href="<?php echo U('Ucenter/Index/following',array('uid'=>$user_info['uid']));?>" title="<?php echo L('');?>"><?php echo ($user_info["following"]); ?></a><br><?php echo L('_FOLLOW_');?>
                </div>
            </dd>
        </dl>
    </div>
    <div class="col-md-6 col-xs-8">
        <div class="uc_main_info">
            ...
            <div class="uc_m_b_12 text-more" style="width: 100%"><?php echo L('_CHARACTER_SIGN_'); echo L('_COLON_');?><span>
            ...
            <div class="uc_m_b_12">
                <span class="uc_m_r_36"><?php echo L('_CREDITS_'); echo L('_COLON_'); echo ($user_info["score"]); ?>&nbsp;&nbsp;
                </span>
            </div>
            <div class="uc_m_b_12"><span><?php echo L('_GRADES_'); echo L('_COLON_'); echo ($user_info["title"]); ?></span></div>
            <?php if(!empty($user_info['tags'])): ?><div class="uc_m_b_12">
                    <span>
                        <?php echo L('_INDIVIDUAL_TAGS_'); echo L('_COLON_');?>
        ...
        <div class="col-xs-7 ">
            <div class="common-block ">
                <header class="clearfix ">
                    <div class="pull-left bottom-line"><?php echo L('_DETAIL_');?></div>
                            ...
                            <div class="col-xs-12">
                                <div style="padding-left: 16px;">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-primary"><?php echo (friendlydate($weibo["create_time"])); ?></span>
        ...
        <div class="col-xs-5">
            <div class="common-block ">
                <header class="clearfix md">
                    <div class="pull-left bottom-line"><?php echo L('_TIP_FAVOR_PEOPLE_');?></div>
                    <div class="pull-right bottom-line " style="border-bottom: none"><?php echo ($supported["count"]); ?> <span
                            class="text-muted">人</span></div>
                </header>

                <section>
                    <?php if(empty($supported["data"])): ?><div style="width: 210px;margin: auto" class="alert with-icon">
                            <i class="icon-inbox"></i>

                            <div class="content"><?php echo L('_TIP_FAVOR_NOBODY_');?></div>
                        </div><?php endif; ?>
                    <ul class="supported-users clearfix">
                        <?php if(is_array($supported["data"])): $i = 0; $__LIST__ = $supported["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="text-center text-ellipsis col-xs-3">
                                <a href="<?php echo ($vo["user"]["space_url"]); ?>" target="_blank" ucard="<?php echo ($vo["uid"]); ?>"><img
                                        style="width:64px;" class="avatar-img" src="<?php echo ($vo["user"]["avatar128"]); ?>"></a>
                                <br/>
                                <?php echo ($vo["user"]["space_link"]); ?>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                    <div class="text-center">
                        <?php echo ($supported["html"]); ?>
                    </div>
                </section>
