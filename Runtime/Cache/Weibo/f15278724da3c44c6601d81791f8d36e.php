...
<div class="check-tab">
    <div class="col-xs-4 text-center active" data-role="change_rank" data-type="today"><?php echo L('_TODAY_CHECKED_');?></div>
    <div class="col-xs-4 text-center" data-role="change_rank" data-type="con"><?php echo L('_CON_CHECKED_');?></div>
    <div class="col-xs-4 text-center" data-role="change_rank" data-type="total"><?php echo L('_TOTAL_CHECKED_');?></div>
</div>
