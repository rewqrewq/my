...
<?php } ?>
    ...
    <link type="text/css" rel="stylesheet" href="/my/Application/News/Static/css/news.css"/>
...
<!--顶部导航之后的钩子，调用公告等 end-->
        ...
        <div class="row">
            <div class="col-xs-12 col-lg-8">
                <div class="common_block_border">
                    ...
                    <div class="common_block_title clearfix">
                        <?php if($info['cover'] != 0): ?><div class="col-xs-4">
                            ...
                            <div class="col-xs-8">
                                ...
                                <p class="clearfix">
                                    <?php if(check_auth('News/Index/edit',-1)||(($info['uid'] == is_login())&&($info['status'] != 1))): ?><a title="编辑" href="<?php echo U('News/index/edit',array('id'=>$info['id']));?>" style="float: right"><i class="icon-edit" style="font-size: 16px;">编辑</i></a><?php endif; ?>
                    ...
                    <section id="contents">
                        <?php if($info['source'] != ''): ?><div style="margin-bottom: 20px;color: #C0C0C0;"><i class="icon-chrome"></i> 来源：<?php echo ($info["source"]); ?></div><?php endif; ?>
    ...
    <script type="text/javascript" charset="utf-8" src="/my/Public/static/ueditor/third-party/SyntaxHighlighter/shCore.js"></script>
    <link rel="stylesheet" type="text/css" href="/my/Public/static/ueditor/third-party/SyntaxHighlighter/shCoreDefault.css"/>
    <script type="text/javascript">
