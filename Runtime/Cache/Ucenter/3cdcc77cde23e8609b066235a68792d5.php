    ...
    <!-- /.navbar-collapse -->
            ...
            <div class="row uc_content">
                <div class="col-xs-7">
                    ...
                    <?php if(count($fans) == 0): ?><p class="text-muted" style="text-align: center; font-size: 3em;">
                        <br><br>
                        <?php echo L('_FANS_NONE_'); echo L('_WAVE_');?>
                        <br><br><br>
                    </p><?php endif; ?>
                    <div style="margin: 20px 0 20px 20px;">
                        <?php if(is_array($fans)): $i = 0; $__LIST__ = $fans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fan): $mod = ($i % 2 );++$i;?><div class="row"
                                 style="border-bottom: 1px solid #dedede;padding-bottom: 20px;padding-top:20px;margin-left: 0;margin-right: 0">
                                <div class="col-xs-2">
                                    <img ucard="<?php echo ($fan["who_follow"]); ?>" style="width: 80px" class="avatar-img"
                                         src="<?php echo ($fan["user"]["avatar128"]); ?>"/>
                                </div>
                                <div class="col-xs-10">
                                    <div><a href="<?php echo ($fan["user"]["space_url"]); ?>"
                                            ucard="<?php echo ($fan["who_follow"]); ?>"><?php echo ($fan["user"]["nickname"]); ?></a><br/>
