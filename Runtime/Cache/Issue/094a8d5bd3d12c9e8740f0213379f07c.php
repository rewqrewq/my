...
<script src="/my/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/my/Application/Issue/Static/css/issue.css" rel="stylesheet" type="text/css"/>
...
<div class="content-body col-md-12">
    ...
    <!-- /.modal -->
        ...
        <script type="text/javascript" src="/my/Public/static/uploadify/jquery.uploadify.min.js"></script>
        <script>
            $(function () {
        ...
        <script type="text/javascript">
            ...
            $("#upload_picture_cover").uploadify({
                "height"          : 30,
                "swf"             : "/my/Public/static/uploadify/uploadify.swf",
