...
class UserModel
{
    private $table_fields = array(
        //member
        'uid', 'nickname', 'sex', 'birthday', 'qq', 'signature', 'pos_province', 'pos_city', 'pos_district', 'pos_community', 'score1', 'score2', 'score3', 'score4',
        //ucmember
...
//获取个人中心地址
        ...
        if (array_intersect(array('space_url', 'space_link', 'space_mob_url'), $fields)) {
            $urls['space_url'] = U('Ucenter/Index/index', array('uid' => $uid));
